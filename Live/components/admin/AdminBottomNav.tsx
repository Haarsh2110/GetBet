...
export default function AdminBottomNav() {
    ...
    return (
        <div className="absolute pb-[env(safe-area-inset-bottom)] bottom-0 left-0 w-full bg-[#0A0A0A] border-t border-white/5 flex justify-around items-center py-4 px-4 z-50 rounded-t-3xl shadow-[0_-10px_40px_rgba(0,0,0,0.8)]">
