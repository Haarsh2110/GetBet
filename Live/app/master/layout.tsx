...
export default function MasterLayout({ children }: { children: React.ReactNode }) {
    ...
    const routes = [
        ...
        { name: 'User Management', path: '/master/users', icon: Users },
        { name: 'Finance Logs', path: '/master/finances', icon: Wallet },
        { name: 'System Settings', path: '/master/settings', icon: Settings },
    ];
        ...
        <div className="min-h-screen bg-background text-white flex overflow-hidden">
            ...
            <aside className="hidden lg:flex w-80 bg-surface/30 border-r border-white/5 flex-col p-8 transition-all relative overflow-y-auto">
                <div className="flex items-center gap-4 mb-20 px-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-black italic tracking-tighter uppercase leading-none">Admin</h1>
                        <p className="text-[10px] text-primary/60 font-black uppercase tracking-widest mt-1">Control Panel</p>
                    </div>
                </div>
