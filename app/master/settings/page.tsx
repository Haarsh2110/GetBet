...
export default function MasterSettings() {
    ...
    if (loading) return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-primary text-[10px] font-black tracking-widest uppercase">Synchronizing Protocols...</p>
        </div>
    );
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 py-2">
                <div>
                    ...
                    <h1 className="text-3xl md:text-6xl font-black italic tracking-tighter uppercase leading-none">
                        System <span className="text-primary font-black italic">Config</span>
                    </h1>
                    <p className="text-gray-500 text-[10px] uppercase font-black tracking-widest mt-4">Global Variables & Maintenance Protocols</p>
                </div>
                    ...
                    <div className="space-y-8 relative z-10">
                        ...
                        <div className="flex items-center justify-between p-7 rounded-[32px] bg-black/40 border border-white/5 transition hover:border-primary/20 group/item">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className={`font-black text-sm uppercase italic tracking-tight ${maintenance ? 'text-red-500' : 'text-white/80'}`}>Maintenance Lock</p>
                        ...
                        <div className="flex items-center justify-between p-7 rounded-[32px] bg-black/40 border border-white/5 transition hover:border-primary/20 group/item">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="font-black text-sm uppercase italic tracking-tight">Withdrawal Hub</p>
