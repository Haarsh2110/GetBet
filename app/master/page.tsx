...
export default function MasterDashboard() {
    ...
    if (loading) return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-primary text-[10px] font-black tracking-widest uppercase">Syncing Master Node...</p>
        </div>
    );

    const kpis = [
        { label: 'Total Users', value: stats?.totalUsers || 0, sub: 'Accounts Synced', icon: Users, color: 'text-blue-400' },
        { label: 'Volume (30D)', value: `₹${stats?.volume30d?.toLocaleString() || 0}`, sub: 'Project Turnover', icon: Wallet, color: 'text-green-400' },
        { label: 'Wingo Total', value: stats?.wingoBets || 0, sub: 'Calculated Bets', icon: Zap, color: 'text-yellow-400' },
        { label: 'Active Games', value: stats?.activeGames || 0, sub: 'Ready for Action', icon: TrendingUp, color: 'text-orange-400' },
    ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-surface border border-white/5 rounded-[48px] p-8 md:p-12 shadow-2xl relative overflow-hidden">
                     <h2 className="text-lg font-black italic uppercase tracking-widest mb-10 flex items-center gap-3">
                        <TrendingUp size={20} className="text-primary" /> Project Velocity
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[9px] text-gray-500 font-bold uppercase tracking-widest mt-1">
                                            {log.totalOrder.toLocaleString()} Effective Transfers
                                        </p>
                                    </div>
                                </div>
                ...
                <div className="bg-surface border border-white/5 rounded-[48px] p-8 md:p-12 shadow-2xl relative overflow-hidden group">
                    <h2 className="text-[10px] font-black text-primary tracking-[0.4em] uppercase mb-10 border-b border-primary/20 pb-4 flex items-center gap-2 italic">
                        <ShieldCheck size={16} /> Quick Master Overrides
                    </h2>
                    ...
                    <div className="space-y-6">
                        <button onClick={() => router.push('/master/users')} className="w-full p-8 rounded-[40px] bg-white/5 border border-white/5 hover:border-primary transition group/btn text-left relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-xs font-black italic uppercase italic mb-1 flex items-center justify-between">Balance Override <ArrowUpRight className="opacity-40 group-hover/btn:opacity-100 transition" size={16}/></h3>
                                <p className="text-[9px] text-gray-600 font-black uppercase tracking-widest">Inject points instantly</p>
                            </div>
                        </button>
                        ...
                        <button onClick={() => router.push('/master/settings')} className="w-full p-8 rounded-[40px] bg-white/5 border border-white/5 hover:border-red-500 transition group/btn text-left relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-xs font-black italic uppercase italic mt-6 mb-1 flex items-center justify-between">Security Panic <ArrowUpRight className="opacity-40" size={16}/></h3>
                                <p className="text-[9px] text-gray-600 font-black uppercase tracking-widest">Broadcast Lock All</p>
                            </div>
                        </button>
                    </div>
                    ...
                    <div className="mt-12 p-6 rounded-[32px] bg-primary/5 border border-primary/10 flex items-center gap-4">
                        ...
                        <p className="text-[10px] text-gray-600 font-black uppercase leading-relaxed italic">Last master synchronization: <span className="text-white">Active</span></p>
                    </div>
                </div>
            </div>
        </div>
