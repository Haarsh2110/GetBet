            ...
            >
                ...
                <div className="space-y-4">
                    <h1 className="text-4xl font-black italic tracking-tighter uppercase leading-none text-white">
                        System <span className="text-primary">Locked</span>
                    </h1>
                ...
                <div className="bg-surface/50 border border-white/5 backdrop-blur-xl rounded-[40px] p-8 space-y-4 shadow-2xl">
                    <p className="text-gray-400 text-sm font-bold leading-relaxed italic">
                        "The platform is currently undergoing a scheduled infrastructure synchronization to enhance your betting performance."
                    </p>
                ...
                <div className="pt-8">
                    <p className="text-[9px] text-gray-600 font-black uppercase tracking-[0.2em] mb-4">Official Project Intelligence Status</p>
