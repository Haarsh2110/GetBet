...
function PaymentSuccessContent() {
    ...
    if (isUpdating) {
        return (
            <div className="flex flex-col items-center justify-center h-[100dvh] bg-[#0A0A0A] p-6 text-center">
    ...
    return (
        <div className="flex flex-col h-[100dvh] bg-[#0A0A0A] relative overflow-hidden px-6 pt-12 pb-[110px] justify-between">
            {/* Success Icon */}
            <motion.div
