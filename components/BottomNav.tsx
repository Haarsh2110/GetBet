...
export default function BottomNav() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md h-32 bg-gradient-to-t from-background via-background/95 to-transparent z-40 pointer-events-none"></div>

      <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[88%] max-w-[360px] z-50">
